namespace ExportToExcel.DataProcessing
{
    ...
    public class Metadata
    {
        ...
        public Metadata Create<T, TValue>(Expression<Func<T, TValue>> expression)
        {
            if (expression == null)
        ...
        public Metadata Create(MemberInfo memberInfo)
        {
            ...
            if (metadata.DisplayName == null)
                metadata.DisplayName = SplitColumnName(metadata.Name);
            ...
            if (metadata.DataType == null)
                metadata.DataType = SetDataType(memberInfo);
        ...
        private static string SetDataType(MemberInfo memberInfo)
        {
            ...
            if (propertyInfo != null)
                return propertyInfo.PropertyType.AssemblyQualifiedName;

            return (memberInfo as FieldInfo)?.FieldType.AssemblyQualifiedName;
        }
